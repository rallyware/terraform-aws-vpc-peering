...
| Name | Version |
|------|---------|
| <a name="provider_aws.accepter"></a> [aws.accepter](#provider\_aws.accepter) | >= 4.0 |
| <a name="provider_aws.requester"></a> [aws.requester](#provider\_aws.requester) | >= 4.0 |
...
| <a name="input_accepter_route_table_ids"></a> [accepter\_route\_table\_ids](#input\_accepter\_route\_table\_ids) | A list of Accepter Route Table IDs | `list(string)` | `[]` | no |
| <a name="input_accepter_route_tables_count"></a> [accepter\_route\_tables\_count](#input\_accepter\_route\_tables\_count) | A list of Accepter Route Tables count, requires only when subnets aren't created yet | `number` | `null` | no |
| <a name="input_accepter_subnet_ids"></a> [accepter\_subnet\_ids](#input\_accepter\_subnet\_ids) | A list of Accepter Subnet IDs | `list(string)` | `[]` | no |
...
| <a name="input_accepter_subnets_count"></a> [accepter\_subnets\_count](#input\_accepter\_subnets\_count) | A list of Accepter Subnets count, requires only when subnets aren't created yet | `number` | `null` | no |
| <a name="input_accepter_vpc_cidr_blocks"></a> [accepter\_vpc\_cidr\_blocks](#input\_accepter\_vpc\_cidr\_blocks) | A list of Accepter VPC cidr block | `list(string)` | `[]` | no |
...
| <a name="input_requester_route_table_ids"></a> [requester\_route\_table\_ids](#input\_requester\_route\_table\_ids) | A list of Requester Route Table IDs | `list(string)` | `[]` | no |
| <a name="input_requester_route_tables_count"></a> [requester\_route\_tables\_count](#input\_requester\_route\_tables\_count) | A list of Requester Route Tables count, requires only when subnets aren't created yet | `number` | `null` | no |
| <a name="input_requester_subnet_ids"></a> [requester\_subnet\_ids](#input\_requester\_subnet\_ids) | A list of Requester Subnet IDs | `list(string)` | `[]` | no |
...
| <a name="input_requester_subnets_count"></a> [requester\_subnets\_count](#input\_requester\_subnets\_count) | A list of Requester Subnets count, requires only when subnets aren't created yet | `number` | `null` | no |
| <a name="input_requester_vpc_cidr_blocks"></a> [requester\_vpc\_cidr\_blocks](#input\_requester\_vpc\_cidr\_blocks) | A list of Requester VPC cidr block | `list(string)` | `[]` | no |
